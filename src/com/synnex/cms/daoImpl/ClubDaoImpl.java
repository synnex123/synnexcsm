...
public boolean UpdateClubInfoChangeManager(Club club) throws HibernateException {
	...
	/*
	 * @author joeyy	2014/12/12
	 * function getAllClubByUserId
	 ...
	 */
	public List<ClubDto> searchClubByClubNameAndClubLocation(ClubDto clubDto) throws HibernateException{
		List<ClubDto> clubList=new ArrayList<ClubDto>();
		String hql="";
		try {
			session=getSession();
	...
	/*
	* @Author Walker Cheng
	* function add the new Infornation due to add new club
	* 2014/12/19
	* 
	*/
